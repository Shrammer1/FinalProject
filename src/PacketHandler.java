...
public class PacketHandler implements Runnable{
	...
	private vSwitch parentSW;
	
	public PacketHandler(String name, OFMessageAsyncStream strm, Map<Integer, Short> macTable,vSwitch p){
		threadName = name;
		stream = strm;
	    		...
	    		if(msg.getType() == OFType.PACKET_IN){
		            ...
		            */
		            ...
		            if (outPort != null) {
		                ...
		                //if(match.getNetworkProtocol()==1){
		                //	match.setWildcards(OFMatch.OFPFW_TP_SRC + OFMatch.OFPFW_TP_DST);	
		                //}
